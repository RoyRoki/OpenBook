...
<div class="main">
    <div class="card">
        ...
        <form action="upemailServlet" method="post" class="login-form"> 
            <label for="username">New Email:</label>
            <input type="text" id="username" name="newemail" placeholder="Your Email Id..." required><br>
 ...
 <%-- Display error message if update fails --%>
        ...
        <% } 
            if (error != null && error.equals("2")) { %>
                <p style="color: red;">Update is Failed</p>
                 <p style="color: red;">(New Email Id Already Taken!)</p>
        <% } %>
