...
<div class="main">
    <div class="card">
        ...
        <form action="upnameServlet" method="post" class="login-form"> 
            <label for="username">New Name:</label>
            <input type="text" id="username" name="newname" placeholder="Your Name..." required><br>
 ...
 <%-- Display error message if update fails --%>
        ...
        <% } 
            if (error != null && error.equals("2")) { %>
                <p style="color: red;">Update is Failed</p>
                 <p style="color: red;">(New UserName Already Taken!)</p>
        <% } %>
